...
class PdlHentPersonTest {
    ...
    fun full_name_without_middlename() {
        ...
        Java6Assertions.assertThat(name!!.split(" ").toTypedArray().size).isEqualTo(2)
        Java6Assertions.assertThat(name).isEqualTo("Fornavn Etternavn")
    }
    ...
    fun full_name_with_middleName() {
        ...
        val name: String? = pdlHentPerson?.fullName()
        Java6Assertions.assertThat(name!!.split(" ").toTypedArray().size).isEqualTo(3)
        Java6Assertions.assertThat(name).isEqualTo("Fornavn Mellomnavn Etternavn")
    }
    ...
    fun null_when_hentPerson_is_null() {
        ...
        val name: String? = pdlHentPerson.fullName()
        Java6Assertions.assertThat(name).isNull()
    }
