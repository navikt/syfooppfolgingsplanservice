...
class OppfolgingsplanInternControllerV3Test : AbstractRessursTilgangTest() {
    @MockBean
    ...
    @Inject
    private lateinit var oppfolgingsplanInternController: OppfolgingsplanInternControllerV3
