...
CREATE TABLE FEILET_SENDING (
  ...
  number_of_tries             NUMBER(4, 0) NOT NULL,
  max_retries                 NUMBER(4, 0) NOT NULL,
  opprettet                   TIMESTAMP NOT NULL,
  sist_endret                 TIMESTAMP NOT NULL,
  CONSTRAINT FEILET_SENDING_PK PRIMARY KEY (id),
  CONSTRAINT FEILET_SENDING_PLAN_FK FOREIGN KEY (oppfolgingsplanlps_id) REFERENCES OPPFOLGINGSPLANLPS (oppfolgingsplanlps_id)
);
