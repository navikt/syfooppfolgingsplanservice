...
import static no.nav.syfo.pdl.PdlConsumer.pdlConsumer;
...
public class RSBrukerOppfolgingsplanMapper {
    ...
    private static Function<GodkjentPlan, RSAvbruttplan> avbruttplan2rs = godkjentPlan ->
            godkjentPlan.avbruttPlan
                    .map(avbruttPlan -> new RSAvbruttplan()
                            .av(new RSPerson().fnr(avbruttPlan.avAktoerId != null ? pdlConsumer.fnr(avbruttPlan.avAktoerId()) : null))
    ...
    private static Function<Godkjenning, RSGodkjenning> godkjenning2rs = godkjenning ->
            new RSGodkjenning()
                    ...
                    .godkjentAv(new RSPerson()
                            .fnr(pdlConsumer.fnr(godkjenning.godkjentAvAktoerId))
                    )
    ...
    private static Function<Kommentar, RSKommentar> kommentar2rs = kommentar ->
            new RSKommentar()
                    ...
                    .opprettetAv(new RSPerson()
                            .fnr(pdlConsumer.fnr(kommentar.opprettetAvAktoerId)))
                    .opprettetTidspunkt(kommentar.opprettetDato)
                    .sistEndretAv(new RSPerson().fnr(pdlConsumer.fnr(kommentar.sistEndretAvAktoerId)))
    ...
    private static Function<Tiltak, RSTiltak> tiltak2rs = tiltak ->
            new RSTiltak()
                    ...
                    .opprettetAv(new RSPerson()
                            .fnr(pdlConsumer.fnr(tiltak.opprettetAvAktoerId)))
                    .opprettetDato(tiltak.opprettetDato)
                    .sistEndretAv(new RSPerson().fnr(pdlConsumer.fnr(tiltak.sistEndretAvAktoerId)))
    ...
    private static Function<Arbeidsoppgave, RSArbeidsoppgave> arbeidsoppgave2rs = arbeidsoppgave ->
            new RSArbeidsoppgave()
                    ...
                    .opprettetAv(new RSPerson().fnr(pdlConsumer.fnr(arbeidsoppgave.opprettetAvAktoerId)))
                    .opprettetDato(arbeidsoppgave.opprettetDato)
                    .sistEndretAv(new RSPerson().fnr(pdlConsumer.fnr(arbeidsoppgave.sistEndretAvAktoerId)))
    ...
    public static Function<Oppfolgingsplan, RSBrukerOppfolgingsplan> oppfolgingsplan2rs = oppfolgingsplan -> new RSBrukerOppfolgingsplan()
            ...
            .sistEndretAv(new RSPerson().fnr(pdlConsumer.fnr(oppfolgingsplan.sistEndretAvAktoerId)))
            ...
            .arbeidstaker(new RSPerson()
                    .fnr(pdlConsumer.fnr(oppfolgingsplan.arbeidstaker.aktoerId))
