...
public class ArbeidstakerSykmeldingerController {
    ...
    @ResponseBody
    @GetMapping("/")
    public ResponseEntity<List<Sykmelding>> getSendteSykmeldinger(@RequestHeader MultiValueMap<String, String> headers, @RequestParam(required= false, name="_ts") String name) {
    ...
    @ResponseBody
    @GetMapping("/today")
    public ResponseEntity<List<Sykmelding>> getSendteSykmeldingerForPerioden(@RequestHeader MultiValueMap<String, String> headers, @RequestParam(required= false, name="_ts") String name) {
