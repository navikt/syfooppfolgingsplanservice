...
public class STSClientConfig {
    ...
    public static final String SERVICEUSER_USERNAME = "SRVSYFOOPPFOLGINGSPLANSERVICE_USERNAME";
    public static final String SERVICEUSER_PASSWORD = "SRVSYFOOPPFOLGINGSPLANSERVICE_PASSWORD";
